...
# Интервал обновления цен (секунды) - пауза между тиками главного цикла
PRICE_UPDATE_INTERVAL = 1.0  # 1 секунда

# ============================================================
# ПОРОГИ ДИСБАЛАНСА ОБЪЁМОВ
# ============================================================

# Предупреждение о дисбалансе между LONG и SHORT объёмами (%)
WARNING_IMBALANCE_PCT = 5.0  # 5% - логируем предупреждение

# Критический дисбаланс - требуется корректирующее действие (%)
CRITICAL_IMBALANCE_PCT = 10.0  # 10% - закрываем избыточную ногу
