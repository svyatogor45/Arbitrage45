...
| Требование | Статус | Комментарий |
|------------|--------|-------------|
| Частичный вход/выход | | |
| Добор позиции при расширении спреда | | |
| Позиция всегда захеджирована | | |

### 2.10. WebSocket Reconnect

| Требование | Статус | Комментарий |
|------------|--------|-------------|
| Backoff (2, 4, 8, 16, 32 сек) | | |
| PAUSED для пар при потере соединения | | |
| Блокировка операций без WS | | |
...
| Получение позиций через REST | | |
| Закрытие всех позиций при старте | | |
| Перевод пар в PAUSED | | |
